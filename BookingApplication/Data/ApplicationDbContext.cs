...
namespace BookingApplication.Data
{
    public class ApplicationDbContext : IdentityDbContext<BookingApplicationUser>
    {
        ...
        public DbSet<BookingApplication.Models.BookReservation> BookReservations { get; set; }
        public DbSet<BookingApplication.Models.BookingList> BookingLists { get; set; }
    }
}
